...
import {ifDefined, Lifecycle, Option, UUID} from "std"
import {appendChildren, createElement, Frag, Inject, JsxValue} from "jsx"
...
export const GenericModuleView = ({lifecycle, environment, adapter}: Construct) => {
    ...
    const {editing, midiDevices} = environment.project
    ...
    const headerPinOuput: Element = <div className="header-pin"/>
                        ...
                        const createView = (connector: ModuleConnectorAdapter<any, any>) =>
                            elements.push(
                                <ConnectorView lifecycle={lifecycle}
                                               ...
                                               parent={element}
                                               headerPin={connector.direction === Direction.Input ? headerPinInput : headerPinOuput}/>
                            )
