...
import {ValueEventBox} from "@core/data/boxes/ValueEventBox.ts"
...
import {InterpolationFieldAdapter} from "@core/shared/adapters/timeline/event/InterpolationFieldAdapter.ts"
