...
import {IndexedBoxAdapter, SortedBoxAdapterCollection} from "@core/shared/SortedBoxAdapterCollection.ts"
...
import {Gate} from "@core/shared/adapters/devices/instruments/Playfield/Gate.ts"
