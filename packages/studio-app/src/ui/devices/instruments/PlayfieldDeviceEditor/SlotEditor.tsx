...
import {asDefined, clamp, Lifecycle, Option} from "opendaw-std"
...
export const SlotEditor = ({lifecycle, service, adapter}: Construct) => {
    ...
    const {editing, midiDevices, userEditingManager} = project
    ...
    const createParameterLabel = (parameter: AutomatableParameterFieldAdapter) => (
        <div className="parameter-label">
            ...
            <RelativeUnitValueDragging lifecycle={lifecycle}
                                       editing={editing}
                                       parameter={parameter}>
                <ParameterLabel lifecycle={lifecycle} editing={editing} midiDevices={midiDevices}
