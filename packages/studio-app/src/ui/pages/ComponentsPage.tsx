...
import {DefaultObservableValue, Option, panic, UUID} from "opendaw-std"
...
import {RootBox, TimelineBox} from "studio-boxes"
...
export const ComponentsPage: PageFactory<StudioService> = ({lifecycle}: PageContext<StudioService>) => {
    ...
    const timelineBox = TimelineBox.create(boxGraph, UUID.generate(), box => {
    })
