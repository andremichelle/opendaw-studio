...
import {clamp, int, Lifecycle, Option, Selection, ValueAxis} from "lib-std"
...
import {ClipAdapters} from "studio-adapters"
...
export const ClipsArea = ({lifecycle, service, manager, scrollModel, scrollContainer}: Construct) => {
    ...
    const dragAndDrop = new ClipSampleDragAndDrop(project, capturing)
    element.appendChild(
        <SelectionRectangle
            editing={editing}
            lifecycle={lifecycle}
