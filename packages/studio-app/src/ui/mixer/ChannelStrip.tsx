...
import {EmptyExec, Lifecycle, Terminable, UUID} from "opendaw-std"
import {AudioUnitBoxAdapter} from "studio-shared"
import {createElement, DomElement, Frag, Inject} from "opendaw-jsx"
...
import {ChannelStripView} from "@/project/Mixer"
...
export const ChannelStrip = ({lifecycle, service, adapter, compact}: Construct) => {
    ...
    const {editing, midiDevices, mixer, rootBoxAdapter, liveStreamReceiver} = project
